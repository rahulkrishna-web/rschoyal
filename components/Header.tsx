      ...
      <div className="w-full px-6 sm:px-12 lg:px-16 xl:px-24 flex justify-between items-center">
        ...
        <Link href="/" className="flex items-center gap-2.5 group">
          {logoSrc ? (
            ...
            <>
              <div className="w-8 h-8 bg-gradient-to-br from-brand-indigo to-brand-violet rounded-lg flex items-center justify-center text-white font-black text-xl shadow-[0_4px_12px_rgba(79,70,229,0.3)] group-hover:shadow-[0_4px_20px_rgba(79,70,229,0.4)] transition-all duration-300">
                {logoChar}
              </div>
              <div className="flex flex-col">
                ...
                <span className="text-[7.5px] font-bold text-slate-500 tracking-[0.2em] leading-none mt-1.5 uppercase">
                  {brandSub}
                </span>
              </div>
            </>
